...
class AidlContractTest {
    ...
    fun inferenceServiceStubIsGeneratedWithTheContractDescriptor() {
        assertThat(IInferenceService.Stub.DESCRIPTOR).isEqualTo("us.aherrera.skein.ipc.IInferenceService")
    }

    @Test
    fun inferenceCallbackStubIsGeneratedWithTheContractDescriptor() {
        assertThat(IInferenceCallback.Stub.DESCRIPTOR).isEqualTo("us.aherrera.skein.ipc.IInferenceCallback")
    }

    @Test
    fun embedderServiceStubIsGeneratedWithTheContractDescriptor() {
        assertThat(IEmbedderService.Stub.DESCRIPTOR).isEqualTo("us.aherrera.skein.ipc.IEmbedderService")
    }
